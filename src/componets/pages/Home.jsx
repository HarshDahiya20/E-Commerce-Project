    ...
    <>
      ...
      <div className='max-w-[1320px] mx-auto '>
          <div className='p-[40px] text-center'>
              <h1 className='font-bold sm:text-4xl text-2xl'>Celebration wear for Men</h1>
          ...
          <div className='grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-12 mt-5 mb-6 '>
              <div className='bg-white w-72 mx-auto rounded-[10px] shadow-md hover:shadow-2xl duration-500 hover:scale-105 p-4' >
                      ...
                      <div className='mt-2 flex justify-between align-center' > 
                          <p className='text-[18px] font-semibold mt-2 block'>$110 </p>
                          <button className='text-xl cursor-pointer'> <IoBagAddOutline /></button>
                      </div>
              ...
              <div className='bg-white w-72 mx-auto rounded-[10px] shadow-md hover:shadow-2xl duration-500 hover:scale-105 p-4' >
                      ...
                      <div className='mt-2 flex justify-between align-center' > 
                          <p className='text-[18px] font-semibold mt-2 block'>$120 </p>
                          <button className='text-xl cursor-pointer'> <IoBagAddOutline /></button>
                      </div>
              ...
              <div className='bg-white w-72 mx-auto rounded-[10px] shadow-md hover:shadow-2xl duration-500 hover:scale-105 p-4' >
                      ...
                      <div className='mt-2 flex justify-between align-center' > 
                          <p className='text-[18px] font-semibold mt-2 block'>$90 </p>
                          <button className='text-xl cursor-pointer'> <IoBagAddOutline /></button>
                      </div>
              ...
              <div className='bg-white w-72 mx-auto rounded-[10px] shadow-md hover:shadow-2xl duration-500 hover:scale-105 p-4' >
                      ...
                      <div className='mt-2 flex justify-between align-center' > 
                          <p className='text-[18px] font-semibold mt-2 block'>$80 </p>
                          <button className='text-xl cursor-pointer'> <IoBagAddOutline /></button>
                      </div>
          ...
          <div className='p-[40px] text-center'>
              <h1 className='font-bold sm:text-4xl text-2xl'>Celebration wear for Women</h1>
          ...
          <div className='grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-12 mt-5 mb-6 '>
              <div className='bg-white w-72 mx-auto rounded-[10px] shadow-md hover:shadow-2xl duration-500 hover:scale-105 p-4' >
                      ...
                      <div className='mt-2 flex justify-between align-center' > 
                          <p className='text-[18px] font-semibold mt-2 block'>$40 </p>
                          <button className='text-xl cursor-pointer'> <IoBagAddOutline /></button>
                      </div>
              ...
              <div className='bg-white w-72 mx-auto rounded-[10px] shadow-md hover:shadow-2xl duration-500 hover:scale-105 p-4' >
                      ...
                      <div className='mt-2 flex justify-between align-center' > 
                          <p className='text-[18px] font-semibold mt-2 block'>$25 </p>
                          <button className='text-xl cursor-pointer'> <IoBagAddOutline /></button>
                      </div>
              ...
              <div className='bg-white w-72 mx-auto rounded-[10px] shadow-md hover:shadow-2xl duration-500 hover:scale-105 p-4' >
                      ...
                      <div className='mt-2 flex justify-between align-center' > 
                          <p className='text-[18px] font-semibold mt-2 block'>$35</p>
                          <button className='text-xl cursor-pointer'> <IoBagAddOutline /></button>
                      </div>
              ...
              <div className='bg-white w-72 mx-auto rounded-[10px] shadow-md hover:shadow-2xl duration-500 hover:scale-105 p-4' >
                      ...
                      <div className='mt-2 flex justify-between align-center' > 
                          <p className='text-[18px] font-semibold mt-2 block'>$20 </p>
                          <button className='text-xl cursor-pointer'> <IoBagAddOutline /></button>
                      </div>
